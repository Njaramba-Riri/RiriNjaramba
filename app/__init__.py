...
def not_found(e):
    ...
    return render_template("/errors/404.html", permission=Permission), 404
...
def method_not_allowed(e):
    ...
    return render_template('/errors/405.html', permission=Permission), 405
...
def internal_server_error(e):
    ...
    return render_template("errors/serverr.html", permission=Permission), 500
